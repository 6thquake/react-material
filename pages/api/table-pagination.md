---
filename: /packages/material-ui/src/Table/TablePagination.js
---
...
and the [implementation of the component](http://git.dev.sh.ctripcorp.com/sixthquake/react-material/tree/v1-beta/packages/material-ui/src/Table/TablePagination.js)
for more detail.
