...
class Container extends Component {
  ...
  changeBoxPosition(newBoxA, newBoxB) {
    if (newBoxA.getBoundingClientRect().left > newBoxB.getBoundingClientRect().right) {
      ...
      if (
        newBoxA.getBoundingClientRect().bottom <
          newBoxB.getBoundingClientRect().top + newBoxB.getBoundingClientRect().height / 2 &&
        newBoxA.getBoundingClientRect().bottom > newBoxB.getBoundingClientRect().top
      ) {
        PubSub.publish('boxMove', ['left middle-bottom', 'right top-middle']);
      }
      if (
        newBoxA.getBoundingClientRect().bottom < newBoxB.getBoundingClientRect().bottom &&
        newBoxA.getBoundingClientRect().bottom >
          newBoxB.getBoundingClientRect().top + newBoxB.getBoundingClientRect().height / 2
      ) {
      ...
      if (
        newBoxA.getBoundingClientRect().top >
          newBoxB.getBoundingClientRect().top + newBoxB.getBoundingClientRect().height / 2 &&
        newBoxA.getBoundingClientRect().top < newBoxB.getBoundingClientRect().bottom
      ) {
    ...
    if (
      newBoxA.getBoundingClientRect().right <
        newBoxB.getBoundingClientRect().left + newBoxB.getBoundingClientRect().width / 2 &&
      newBoxA.getBoundingClientRect().right > newBoxB.getBoundingClientRect().left
    ) {
      if (newBoxA.getBoundingClientRect().bottom < newBoxB.getBoundingClientRect().top) {
    ...
    if (
      newBoxA.getBoundingClientRect().right < newBoxB.getBoundingClientRect().right &&
      newBoxA.getBoundingClientRect().right >
        newBoxB.getBoundingClientRect().left + newBoxB.getBoundingClientRect().width / 2
    ) {
      if (newBoxA.getBoundingClientRect().bottom < newBoxB.getBoundingClientRect().top) {
    ...
    if (
      newBoxA.getBoundingClientRect().left < newBoxB.getBoundingClientRect().right &&
      newBoxA.getBoundingClientRect().left >
        newBoxB.getBoundingClientRect().left + newBoxB.getBoundingClientRect().width / 2
    ) {
      if (newBoxA.getBoundingClientRect().bottom < newBoxB.getBoundingClientRect().top) {
  ...
  mouseup(event) {
    ...
    if (
      this.state.point.x0 > newBoxA.getBoundingClientRect().left + offsetX &&
      this.state.point.x0 < newBoxA.getBoundingClientRect().right + offsetX &&
      this.state.point.y0 > newBoxA.getBoundingClientRect().top + offsetY &&
      this.state.point.y0 < newBoxA.getBoundingClientRect().bottom + offsetY
    ) {
      if (
        this.state.point.x1 > newBoxB.getBoundingClientRect().left + offsetX &&
        this.state.point.x1 < newBoxB.getBoundingClientRect().right + offsetX &&
        this.state.point.y1 > newBoxB.getBoundingClientRect().top + offsetY &&
        this.state.point.y1 < newBoxB.getBoundingClientRect().bottom + offsetY
      ) {
    ...
    if (
      this.state.point.x1 > newBoxA.getBoundingClientRect().left + offsetX &&
      this.state.point.x1 < newBoxA.getBoundingClientRect().right + offsetX &&
      this.state.point.y1 > newBoxA.getBoundingClientRect().top + offsetY &&
      this.state.point.y1 < newBoxA.getBoundingClientRect().bottom + offsetY
    ) {
      if (
        this.state.point.x0 > newBoxB.getBoundingClientRect().left + offsetX &&
        this.state.point.x0 < newBoxB.getBoundingClientRect().right + offsetX &&
        this.state.point.y0 > newBoxB.getBoundingClientRect().top + offsetY &&
        this.state.point.y0 < newBoxB.getBoundingClientRect().bottom + offsetY
      ) {
  ...
  render() {
    ...
    return connectDropTarget(
      ...
      >
        ...
        {this.props.removeLine ? null : AtoBinproperArea ? (
          <LineTo
            from={ReactDOM.findDOMNode(this.a)}
            to={ReactDOM.findDOMNode(this.b)}
            borderStyle={this.props.borderStyle}
            arrowStyle={this.props.arrowStyle}
          />
        ) : BtoAinproperArea ? (
          <LineTo
            from={ReactDOM.findDOMNode(this.b)}
            to={ReactDOM.findDOMNode(this.a)}
            borderStyle={this.props.borderStyle}
            arrowStyle={this.props.arrowStyle}
          />
        ) : (
          <Line {...this.state.point} borderStyle={'dashed'} />
        )}
      </div>,
    );
  }
