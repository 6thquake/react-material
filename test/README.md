...
Here is an [example](https://github.com/6thquake/react-material/blob/a3719a203515b1ad683e62085cb5065318c0c87f/src/Menu/Menu.spec.js#L18) with the `Menu` component.
...
Here is an [example](https://github.com/6thquake/react-material/blob/a3719a203515b1ad683e62085cb5065318c0c87f/test/integration/Menu.spec.js#L29) with the `Menu` component.
...
Here is an [example](https://github.com/6thquake/react-material/blob/a3719a203515b1ad683e62085cb5065318c0c87f/test/regressions/tests/Menu/SimpleMenuList.js#L7) with the `Menu` component.
...
For all unit tests, please use the [shallow renderer](https://github.com/airbnb/enzyme/blob/master/docs/api/shallow.md) from `enzyme` unless the Component being tested requires a DOM. [Here's](https://github.com/6thquake/react-material/blob/master/src/Avatar/Avatar.spec.js) a small shallow rendered test to get you started.
