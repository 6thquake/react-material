---
filename: /packages/material-ui/core/src/SwipeableDrawer/SwipeableDrawer.js
...
| <span class="prop-name">hysteresis</span> | <span class="prop-type">number | <span class="prop-default">0.55</span> | Affects how far the drawer must be opened/closed to change his state. Specified as percent (0-1) of the width of the drawer |
| <span class="prop-name">minFlingVelocity</span> | <span class="prop-type">number | <span class="prop-default">400</span> | Defines, from which (average) velocity on, the swipe is defined as complete although hysteresis isn't reached. Good threshold is between 250 - 1000 px/s |
...
| <span class="prop-name">SwipeAreaProps</span> | <span class="prop-type">object |   | Properties applied to the swipe area element. |
