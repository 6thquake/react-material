...
Have a look at the [Create React App with TypeScript](http://git.dev.sh.ctripcorp.com/sixthquake/react-material/tree/v1-beta/examples/create-react-app-with-typescript) example.
