...
Alternatively, you can always look at the [implementation details](https://github.com/6thquake/react-material/blob/develop/packages/material-ui/src/Button/Button.js).
