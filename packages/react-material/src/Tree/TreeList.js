    ...
    _createClass(TreeList, [{
        ...
        value: function render() {
            ...
            if (searchTerm) {
                ...
                listItemsModifed = listItemsModifed.map(tagListItemsWithSearchTerm(searchTerm)).map(function (listItem, i, inputArray) {
                    listItem._shouldRender = listItem.searchMatch || childIsTaggedWithSearch(listItem, inputArray);
                    if (listItem.highlight) {
                        ...
                        listItem._primaryText = _react2.default.createElement('span', null, left,
            ...
            return _react2.default.createElement('div', {style: Object.assign({}, styles.root, style)},
                children,
                haveSearchbar && _react2.default.createElement('form', {
