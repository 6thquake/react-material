...
Alternatively, you can always look at the [implementation details](http://git.dev.sh.ctripcorp.com/sixthquake/react-material/blob/develop/packages/material-ui/src/Button/Button.js).
