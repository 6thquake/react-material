...
React-Material uses a **simplified** implementation of the original [specification](https://material.io/design/layout/responsive-layout-grid.html#breakpoints).
...
```jsx
import withWidth, { isWidthUp } from '@6thquake/react-material/withWidth';
