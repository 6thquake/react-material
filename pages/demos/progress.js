...
function Page() {
  return (
    <MarkdownDocs
      markdown={markdown}
      demos={{
        'pages/demos/progress/Progress.js': {
          js: require('docs/src/pages/demos/progress/Progress').default,
          raw: preval`
module.exports = require('fs')
  .readFileSync(require.resolve('docs/src/pages/demos/progress/Progress'), 'utf8')
`,
        },
