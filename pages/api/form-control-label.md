---
filename: /packages/material-ui/core/src/FormControlLabel/FormControlLabel.js
...
| <span class="prop-name">labelPlacement</span> | <span class="prop-type">enum:&nbsp;'end'&nbsp;&#124;<br>&nbsp;'start'&nbsp;&#124;<br>&nbsp;'top'&nbsp;&#124;<br>&nbsp;'bottom'<br> | <span class="prop-default">'end'</span> | The position of the label. |
...
and the [implementation of the component](https://github.com/6thquake/react-material/tree/develop/packages/material-ui/core/src/FormControlLabel/FormControlLabel.js)
for more detail.
