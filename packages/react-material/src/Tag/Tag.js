...
class Tag extends Component {
  ...
  componentDidMount() {}
    ...
    render() {
        ...
        const ChipShow = closable ? <Chip classes={{root:classes[color+size]}} onDelete={this.handleDelete.bind(this)} label={label}></Chip> :
        <Chip classes={{root:classes[color+size]}} label={label}></Chip>
