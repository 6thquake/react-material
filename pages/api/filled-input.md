---
filename: /packages/material-ui/core/src/FilledInput/FilledInput.js
...
| <span class="prop-name">defaultValue</span> | <span class="prop-type">union:&nbsp;string, number, bool, object, arrayOf<br> |   | The default input value, useful when not controlling the component. |
| <span class="prop-name">disabled</span> | <span class="prop-type">bool |   | If `true`, the input will be disabled. |
| <span class="prop-name">disableUnderline</span> | <span class="prop-type">bool |   | If `true`, the input will not have an underline. |
...
| <span class="prop-name">inputComponent</span> | <span class="prop-type">componentPropType |   | The component used for the native input. Either a string to use a DOM element or a component. |
...
| <span class="prop-name">value</span> | <span class="prop-type">union:&nbsp;string, number, bool, object, arrayOf<br> |   | The input value, required for a controlled component. |
...
and the [implementation of the component](https://github.com/6thquake/react-material/tree/develop/packages/material-ui/core/src/FilledInput/FilledInput.js)
for more detail.
