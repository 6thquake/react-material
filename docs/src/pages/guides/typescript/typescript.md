...
Have a look at the [Create React App with TypeScript](https://github.com/6thquake/react-material/tree/develop/examples/create-react-app-with-typescript) example.
