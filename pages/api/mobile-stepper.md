---
filename: /packages/material-ui/core/src/MobileStepper/MobileStepper.js
...
| <span class="prop-name">backButton</span> | <span class="prop-type">node |   | A back button element. For instance, it can be a `Button` or an `IconButton`. |
...
| <span class="prop-name">nextButton</span> | <span class="prop-type">node |   | A next button element. For instance, it can be a `Button` or an `IconButton`. |
...
and the [implementation of the component](https://github.com/6thquake/react-material/tree/develop/packages/material-ui/core/src/MobileStepper/MobileStepper.js)
for more detail.
