...
If you want to learn more about how the theme is assembled, take a look at [`material-ui/style/createMuiTheme.js`](http://git.dev.sh.ctripcorp.com/sixthquake/react-material/blob/develop/packages/material-ui/src/styles/createMuiTheme.js),
