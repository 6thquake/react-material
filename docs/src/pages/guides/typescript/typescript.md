...
Have a look at the [Create React App with TypeScript](https://github.com/6thquake/react-material/tree/master/examples/create-react-app-with-typescript) example. A minimum version of TypeScript 2.8 is required.
...
```ts
import { WithStyles, createStyles } from '@6thquake/react-material';
...
declare module '@6thquake/react-material/styles/createMuiTheme' {
  interface Theme {
    appDrawer: {
