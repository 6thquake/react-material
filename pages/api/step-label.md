---
filename: /packages/material-ui/core/src/StepLabel/StepLabel.js
title: StepLabel API
---
...
| <span class="prop-name">StepIconComponent</span> | <span class="prop-type">componentPropType |   | The component to render in place of the [`StepIcon`](/api/step-icon/). |
...
and the [implementation of the component](https://github.com/6thquake/react-material/tree/develop/packages/material-ui/core/src/StepLabel/StepLabel.js)
for more detail.
