---
filename: /packages/material-ui/src/List/ListItem.js
---
...
and the [implementation of the component](http://git.dev.sh.ctripcorp.com/sixthquake/react-material/tree/develop/packages/material-ui/src/List/ListItem.js)
for more detail.
