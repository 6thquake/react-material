---
filename: /packages/material-ui/core/src/InputBase/InputBase.js
title: InputBase API
---
...
| <span class="prop-name">inputComponent</span> | <span class="prop-type">componentPropType | <span class="prop-default">'input'</span> | The component used for the native input. Either a string to use a DOM element or a component. |
...
and the [implementation of the component](https://github.com/6thquake/react-material/tree/develop/packages/material-ui/core/src/InputBase/InputBase.js)
for more detail.
