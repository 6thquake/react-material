  ...
  beginDrag(props, monitor, component) {
    ...
    */
    ...
    if(props.type =='POSITION'){
    	//拿到当前node的index
    	const _from = component.decoratedComponentInstance.refs.mytttest.offsetParent.parentNode.getAttribute('datakey')
    	item.sortFrom = _from;
...
class MyComponent extends Component {
	...
	render() {
		const {connectDragSource,connectDropTarget,children,isDragging,type,classes,rows,cols} = this.props;
		let _style = {};
		if(type =='POSITION'){
