...
class Tag extends Component {
    ...
    render() {
        ...
        const clear =  closable?<Clear onClick={(e) => this.onClick(e)} className={classes.clearTag} />:null;

        return close ? (<Fade in={close}><div className={classes.rmTag + ' ' + classes[color]}>
