...
To learn more about our internal tests, you can have a look at the [README](http://git.dev.sh.ctripcorp.com/sixthquake/react-material/blob/v1-beta/test/README.md).
